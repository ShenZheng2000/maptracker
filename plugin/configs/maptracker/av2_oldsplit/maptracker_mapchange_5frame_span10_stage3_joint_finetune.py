...
new_val_pkl = '/scratch/shenzhen/datasets/mapchange/av2_map_infos_val.pkl'
new_train_pkl = '/scratch/shenzhen/datasets/mapchange/av2_map_infos_train.pkl'
...
work_dir = 'work_dirs/maptracker_mapchange_5frame_span10_stage3_joint_finetune'
load_from = 'work_dirs/maptracker_mapchange_5frame_span10_stage2_warmup/latest.pth'