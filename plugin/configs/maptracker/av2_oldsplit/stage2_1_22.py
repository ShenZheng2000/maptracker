...
work_dir = 'work_dirs/stage2_1_22'
# load_from = 'work_dirs/backups/debug_stage1_bev_pretrain/latest.pth'
load_from = 'work_dirs/maptracker_argoverse2_geosplit_5frame_span10_stage1_bev_pretrain/latest.pth' # NOTE: let's reuse pretrained stage1!